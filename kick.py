...
TOR_SOCKS_PORTS = (
    ...
    list(range(9140, 9170, 2)) + list(range(9240, 9270, 2)) + list(range(9200, 9230, 2)) +
    list(range(9280, 9310, 2)) + list(range(9310, 9340, 2)) + list(range(9340, 9370, 2)) +
    list(range(9370, 9400, 2)) + list(range(9400, 9430, 2)) + list(range(9430, 9460, 2))
)
TOR_CONTROL_PORTS = [9051, 9061, 9071, 9081, 9091, 9101, 9111, 9121, 9131, 9141, 9151, 9161]
TOR_PASSWORD = ""
USE_TOR = True
